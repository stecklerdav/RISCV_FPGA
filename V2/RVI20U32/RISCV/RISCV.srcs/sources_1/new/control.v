    ...
    always @(*) begin
        ...
        case (opcode)
            ...
            7'b0000011: begin
                ...
                case (funct3)
                    3'b000: begin mem_size = SZ_B; mem_sign_ext = 1'b1; end
                    3'b001: begin mem_size = SZ_H; mem_sign_ext = 1'b1; end
                    3'b010: begin mem_size = SZ_W; mem_sign_ext = 1'b1; end
                    3'b100: begin mem_size = SZ_B; mem_sign_ext = 1'b0; end
                    3'b101: begin mem_size = SZ_H; mem_sign_ext = 1'b0; end
                    default: begin mem_size = SZ_W; mem_sign_ext = 1'b1; end
                endcase
            end
