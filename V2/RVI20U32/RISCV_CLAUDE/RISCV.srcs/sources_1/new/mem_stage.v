...
module mem_stage (
    ...
    // IMPORTANTE:
    // Por compatibilidad con Vivado Block Design se conserva el nombre
    // mem_unsigned, pero semánticamente esta señal es mem_sign_ext:
    //   1 = signed load   -> LB/LH
    //   0 = unsigned load -> LBU/LHU
    ...
    // Mismo comentario: nombre viejo, significado real = sign_ext
    ...
    // Internamente usamos el nombre correcto.
    // Esta señal vale:
    //   1 = sign extend
    //   0 = zero extend
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            // El puerto se llama unsigned, pero realmente viene de control.mem_sign_ext.
            mem_q_mem_sign_ext <= mem_in_mem_unsigned;
    ...
    always @(*) begin
        ...
        // Nombre viejo, significado real = sign_ext
