...
(* CORE_GENERATION_INFO = "BASIC,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BASIC,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=71,numReposBlks=58,numNonXlnxBlks=0,numHierBlks=13,maxHierDepth=3,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=53,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "BASIC.hwdef" *) 
module BASIC
   (SW1,
    gpio_out_0);
  input [0:0]SW1;
  ...
  BASIC_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(sim_constant_0_dout),
        .ext_reset_in(zynq_ultra_ps_e_0_pl_resetn0),
        .mb_debug_sys_rst(1'b0),
        .peripheral_reset(proc_sys_reset_0_peripheral_reset1),
        .slowest_sync_clk(zynq_ultra_ps_e_0_pl_clk0));
  BASIC_sim_constant_0_5 sim_constant_0
       (.dout(sim_constant_0_dout));
  BASIC_util_vector_or_1_0 util_vector_or_1
  ...
  BASIC_xlconcat_8_0_0 xlconcat_8_0
  ...
  BASIC_xlslice_2bit_0_0 xlslice_2bit_0
       (.Din(gpio_0_gpio_out),
...
module PRIVILEGED_imp_TDUXP9
  ...
  BASIC_exception_mux_0_0 exception_mux_0
  ...
  BASIC_mem_exception_merge_0_0 mem_exception_merge_0
  ...
  BASIC_trap_controller_0_0 trap_controller_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .trap_mtval(trap_controller_0_trap_mtval),
        .trap_target(trap_controller_0_trap_target));
  BASIC_util_vector_and_0_3 util_vector_and_0
       (.Op1(illegal_instr_1),
        .Op2(util_vector_not_0_Res),
        .Res(util_vector_and_0_Res));
  BASIC_util_vector_not_0_3 util_vector_not_0
...
module RV32I_EX_imp_VZHXQ1
  ...
  BASIC_sim_constant_0_3 sim_constant_0
       (.dout(sim_constant_0_dout));
  BASIC_util_vector_and_0_5 util_vector_and_0
       (.Op1(ex_mem_reg_1_mem_valid),
        .Op2(ex_mem_reg_1_mem_rd_we),
        .Res(util_vector_and_0_Res));
  BASIC_util_vector_and_0_6 util_vector_and_1
...
module RV32I_IF_imp_136QK4M
  ...
  BASIC_pc_unit_0_0 pc_unit_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .priv_redirect_valid(priv_redirect_valid_1),
        .rst(proc_sys_reset_0_peripheral_reset));
  BASIC_util_vector_and_0_1 util_vector_and_0
       (.Op1(branch_predictor_btb_0_pred_valid),
        .Op2(branch_predictor_btb_0_pred_taken),
        .Res(util_vector_and_0_Res));
  BASIC_util_vector_and_0_2 util_vector_and_1
       (.Op1(pc_en_1),
        .Op2(util_vector_not_0_Res),
        .Res(util_vector_and_1_Res));
  BASIC_util_vector_not_0_1 util_vector_not_0
       (.Op1(Op3_1),
        .Res(util_vector_not_0_Res));
  BASIC_util_vector_not_0_2 util_vector_not_1
       (.Op1(util_vector_logic_7_Res),
        .Res(util_vector_not_1_Res));
  BASIC_util_vector_or_0_1 util_vector_or_0
       (.Op1(flush_1),
        .Op2(Op4_1),
        .Res(util_vector_or_0_Res));
  BASIC_util_vector_or_0_2 util_vector_or_1
       (.Op1(Op3_1),
        .Op2(hold_1),
...
module RV32I_MEM_imp_12Q40FU
  ...
  BASIC_regfile_we_gen_0_0 regfile_we_gen_0
       (.regfile_we(regfile_we_gen_0_regfile_we),
        ...
        .wb_rd_we(mem_wb_reg_0_wb_rd_we),
        .wb_valid(mem_wb_reg_0_wb_valid));
  BASIC_sim_constant_0_4 sim_constant_0
       (.dout(xlconstant_3_dout));
endmodule
