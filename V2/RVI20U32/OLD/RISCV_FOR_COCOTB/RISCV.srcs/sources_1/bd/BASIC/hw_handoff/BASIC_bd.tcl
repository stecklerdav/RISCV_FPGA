...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_ports rst] [get_bd_pins Core_RV32I/rst] [get_bd_pins GPIO/rst] [get_bd_pins MMIO/rst] [get_bd_pins PRIVILEGED/rst] [get_bd_pins RV32I_RAM_MEMORY/rst] [get_bd_pins TIMER/rst] [get_bd_pins UART/rst]
