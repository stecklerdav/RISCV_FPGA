...
(* CORE_GENERATION_INFO = "BASIC,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BASIC,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=65,numReposBlks=53,numNonXlnxBlks=0,numHierBlks=12,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=52,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "BASIC.hwdef" *) 
module BASIC
   (SW1,
    clk,
    gpio_out_0,
...
module RV32I_IF_imp_136QK4M
  ...
  BASIC_pc_unit_0_0 pc_unit_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .priv_redirect_valid(priv_redirect_valid_1),
        .rst(proc_sys_reset_0_peripheral_reset));
  BASIC_rom_memory_0_0 rom_memory_0
       (.addr(pc_to_imem_addr_0_addr),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
