...
# module references:
# sim_constant, util_vector_or, xlconcat_8, xlslice_2bit, load_use_detection, priority_branch_OR_load_use, gpio, mem_bus_registered, csr_access_unit, csr_file, csr_regfile_wb_mux, exception_mux, mem_exception_merge, privileged_pc_redirect_mux, system_decoder, trap_controller, util_vector_and, util_vector_not, ram_data, timer, uart_tx, alu, branch, ex_mem_reg, forward_mux, forward_mux, forward_mux, forwarding, operand_a_mux, operand_b_mux, sim_constant, util_vector_and, util_vector_and, control, decoder, id_ex_reg, imm_mux, regfile, branch_predictor_btb_bht, if_id_reg, pc_to_imem_addr, pc_unit, util_vector_and, util_vector_and, util_vector_not, util_vector_not, util_vector_or, util_vector_or, mem_stage, mem_wb_reg, regfile_we_gen, sim_constant, wb_mux
...
proc create_hier_cell_RV32I_IF { parentCell nameHier } {
  ...
  connect_bd_net -net util_vector_not_1_Res [get_bd_pins RV32I_ROM_MEMORY/ena] [get_bd_pins util_vector_not_1/Res]
...
proc create_hier_cell_UART { parentCell nameHier } {
  ...
  connect_bd_net -net rx_1 [get_bd_pins rx] [get_bd_pins uart_tx_0/rx]
  ...
  connect_bd_net -net uart_tx_0_tx [get_bd_pins tx] [get_bd_pins uart_tx_0/tx]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins Core_RV32I/rst] [get_bd_pins GPIO/rst] [get_bd_pins MMIO/rst] [get_bd_pins PRIVILEGED/rst] [get_bd_pins RV32I_RAM_MEMORY/rst] [get_bd_pins TIMER/rst] [get_bd_pins UART/rst] [get_bd_pins util_vector_or_1/Res]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset1 [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_pins util_vector_or_1/Op1]
  connect_bd_net -net ram_ready_1 [get_bd_pins MMIO/ram_ready] [get_bd_pins RV32I_RAM_MEMORY/ready]
  connect_bd_net -net sim_constant_0_dout [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins sim_constant_0/dout]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins util_vector_or_1/Op2] [get_bd_pins vio_0/probe_out0]
