...
HD_PWD='/media/steckler/xilinx_linux/RISCV_ZYNQ/V2/RVI20U32/RV32I_COCOTB/RISCV_RV32MI/RISCV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32MI_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32MI_wrapper.tcl
