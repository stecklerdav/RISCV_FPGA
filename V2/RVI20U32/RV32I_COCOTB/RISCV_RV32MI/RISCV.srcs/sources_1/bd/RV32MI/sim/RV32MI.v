...
//Date        : Fri Jun 19 23:24:04 2026
//Host        : steckler-Default-string running 64-bit Ubuntu 18.04.6 LTS
//Command     : generate_target RV32MI.bd
//Design      : RV32MI
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module Core_RV32I_imp_12DLIY9
   (clk,
    csr_use_id_ex_flush,
    csr_use_if_id_hold,
    csr_use_pc_en,
  ...
  RV32I_MEM_imp_FF35PV RV32I_MEM
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  RV32I_WB_imp_1JJXF7L RV32I_WB
       (.alu_y(RV32I_MEM_wb_alu_result),
        ...
        .wb_sel(RV32I_MEM_wb_sel));
  RV32MI_load_use_detection_0_0 load_use_detection_0
  ...
  RV32MI_priority_branch_OR_l_0_0 priority_branch_OR_l_0
...
module MMIO_imp_1JB76I9
  ...
  RV32MI_mem_bus_registered_0_0 mem_bus_registered_0
       (.clk(clk_1),
...
module PRIVILEGED_imp_14N4UC2
  ...
  assign zynq_ultra_ps_e_0_pl_clk0 = clk;
  RV32MI_csr_access_unit_0_0 csr_access_unit_0
  ...
  RV32MI_csr_file_0_0 csr_file_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  RV32MI_csr_regfile_wb_mux_0_0 csr_regfile_wb_mux_0
  ...
  RV32MI_csr_use_detection_0_0 csr_use_detection_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .rst(proc_sys_reset_0_peripheral_reset));
  RV32MI_exception_mux_0_0 exception_mux_0
  ...
  RV32MI_mem_exception_merge_0_0 mem_exception_merge_0
  ...
  RV32MI_privileged_pc_redire_0_0 privileged_pc_redire_0
  ...
  RV32MI_system_decoder_0_0 system_decoder_0
       (.csr_addr(system_decoder_0_csr_addr),
        .csr_rd(system_decoder_0_csr_rd),
        .csr_rs1(system_decoder_0_csr_rs1),
  ...
  RV32MI_trap_controller_0_0 trap_controller_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .csr_mepc(csr_file_0_csr_mepc),
        .csr_mie(csr_file_0_csr_mie),
        .csr_mip(csr_file_0_csr_mip),
        ...
        .trap_mtval(trap_controller_0_trap_mtval),
        .trap_target(trap_controller_0_trap_target));
  RV32MI_util_vector_and_0_2 util_vector_and_0
       (.Op1(illegal_instr_1),
        .Op2(util_vector_not_0_Res),
        .Res(util_vector_and_0_Res));
  RV32MI_util_vector_not_0_1 util_vector_not_0
       (.Op1(system_decoder_0_is_system),
        .Res(util_vector_not_0_Res));
endmodule

module RV32I_EX_imp_EPOEC7
   (alu_op,
  ...
  RV32MI_constant_zero_0_1 constant_zero_0
       (.dout(constant_zero_0_dout));
  RV32MI_ex_mem_reg_0 ex_mem_reg
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .rst(proc_sys_reset_0_peripheral_reset),
        .stall(stall_1));
  RV32MI_forward_mux_0_0 forward_mux_0
  ...
  RV32MI_forward_mux_1_0 forward_mux_1
  ...
  RV32MI_forward_mux_2_0 forward_mux_2
       (.base_data(id_ex_reg_0_ex_rs2_data),
        .ex_mem_data(ex_mem_reg_1_mem_alu_result),
  ...
  RV32MI_forwarding_0_0 forwarding_0
...
module RV32I_IF_imp_NNXF0R
  ...
  assign zynq_ultra_ps_e_0_pl_clk0 = clk;
  RV32MI_branch_predictor_btb_0_0 branch_predictor_btb_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .if_pc(pc_unit_0_pc),
  ...
  RV32MI_constant_one_0_0 constant_one_0
       (.dout(constant_one_0_dout));
  RV32MI_if_id_reg_0_0 if_id_reg_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .rst(proc_sys_reset_0_peripheral_reset));
  RV32MI_pc_to_imem_addr_0_0 pc_to_imem_addr_0
       (.addr(pc_to_imem_addr_0_addr),
        .pc(pc_unit_0_pc));
  RV32MI_pc_unit_0_0 pc_unit_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .pc(pc_unit_0_pc),
        ...
        .priv_redirect_valid(priv_redirect_valid_1),
        .rst(proc_sys_reset_0_peripheral_reset));
  RV32MI_rom_memory_0_0 rom_memory_0
       (.addr(pc_to_imem_addr_0_addr),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .dout(rom_memory_0_dout),
        .en(ena_1));
  RV32MI_util_vector_and_0_1 util_vector_and_0
       (.Op1(branch_predictor_btb_0_pred_valid),
        .Op2(branch_predictor_btb_0_pred_taken));
  RV32MI_util_vector_and_1_1 util_vector_and_1
       (.Op1(pc_en_1),
        .Op2(util_vector_not_0_Res),
        .Res(util_vector_and_1_Res));
  RV32MI_util_vector_not_0_0 util_vector_not_0
       (.Op1(Op3_1),
        .Res(util_vector_not_0_Res));
  RV32MI_util_vector_not_1_0 util_vector_not_1
       (.Op1(util_vector_or_1_Res),
        .Res(ena_1));
  RV32MI_util_vector_or_0_0 util_vector_or_0
       (.Op1(flush_1),
        .Op2(Op4_1),
        .Res(util_vector_or_0_Res));
  RV32MI_util_vector_or_1_0 util_vector_or_1
       (.Op1(hold_1),
        .Op2(Op3_1),
        .Res(util_vector_or_1_Res));
endmodule

module RV32I_MEM_imp_FF35PV
   (clk,
    dmem_addr,
    dmem_be,
    dmem_error,
  ...
  assign zynq_ultra_ps_e_0_pl_clk0 = clk;
  RV32MI_constant_zero_0_0 constant_zero_0
       (.dout(xlconstant_3_dout));
  RV32MI_mem_stage_0_0 mem_stage_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  RV32MI_mem_wb_reg_0_0 mem_wb_reg_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  RV32MI_regfile_we_gen_0_0 regfile_we_gen_0
...
module RV32I_RAM_MEMORY_imp_11KTM8V
   (addr,
    be,
    clk,
    rdata,
  ...
  assign zynq_ultra_ps_e_0_pl_clk0 = clk;
  RV32MI_ram_data_1_0 ram_data_1
...
(* CORE_GENERATION_INFO = "RV32MI,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RV32MI,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=72,numReposBlks=60,numNonXlnxBlks=0,numHierBlks=12,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=54,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "RV32MI.hwdef" *) 
module RV32MI
   (SW1,
    gpio_out_0);
  input [0:0]SW1;
  ...
  Core_RV32I_imp_12DLIY9 Core_RV32I
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  MMIO_imp_1JB76I9 MMIO
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .uart_wdata(wdata_3),
        .uart_we(we_3));
  PRIVILEGED_imp_14N4UC2 PRIVILEGED
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .trap_flush(trap_controller_0_trap_flush));
  RV32I_RAM_MEMORY_imp_11KTM8V RV32I_RAM_MEMORY
       (.addr(addr_1),
        .be(be_1),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  UART_imp_MI8NW0 UART
       (.addr(addr_3),
        ...
        .wdata(wdata_3),
        .we(we_3));
  RV32MI_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
  ...
  RV32MI_util_vector_logic_2_0 util_vector_logic_2
       (.Op1(proc_sys_reset_0_peripheral_reset2),
        .Op2(vio_0_probe_out0),
        .Res(proc_sys_reset_0_peripheral_reset));
  RV32MI_util_vector_logic_3_0 util_vector_logic_3
       (.Op1(SW1_1),
        .Op2(vio_0_probe_out1),
        .Res(hier_0_Res1));
  RV32MI_vio_0_0 vio_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .probe_out0(vio_0_probe_out0),
        .probe_out1(vio_0_probe_out1));
  RV32MI_xlconcat_8_0_0 xlconcat_8_0
       (.dout(xlconcat_8_0_dout),
        ...
        .in6(hier_0_Res1),
        .in7(hier_0_Res1));
  RV32MI_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  RV32MI_xlslice_2bit_0_0 xlslice_2bit_0
       (.Din(gpio_0_gpio_out),
        .Dout(xlslice_2bit_0_Dout));
  RV32MI_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
