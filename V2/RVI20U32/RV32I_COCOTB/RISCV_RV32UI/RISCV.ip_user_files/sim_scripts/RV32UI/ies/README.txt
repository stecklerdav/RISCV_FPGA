...
#
# Generated by export_simulation on Wed Jun 17 01:00:29 WEST 2026
#
################################################################################
...
'-reset_run' switch to the './RV32UI.sh' script.
...
./RV32UI.sh -noclean_files

For more information on the script, please type './RV32UI.sh -help'.
