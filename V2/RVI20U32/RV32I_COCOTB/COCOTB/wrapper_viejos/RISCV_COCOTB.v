...
module Core_RV32I_imp_BFBAKD
  ...
  RV32I_EX_imp_J96COH RV32I_EX
       (.alu_op(alu_op_1),
        ...
        .mem_wb_data(rd_wdata1_1),//.mem_wb_data(wb_mux_0_rd_wdata),
        ...
        .stall(Op3_1),
        .wb_rd(rd_addr1_1),//.wb_rd(mem_wb_reg_0_wb_rd),
        .wb_rd_we(rd_we1_1),//.wb_rd_we(RV32I_MEM_regfile_we),
        .wb_valid(rd_we1_1));//.wb_valid(RV32I_MEM_wb_valid));
