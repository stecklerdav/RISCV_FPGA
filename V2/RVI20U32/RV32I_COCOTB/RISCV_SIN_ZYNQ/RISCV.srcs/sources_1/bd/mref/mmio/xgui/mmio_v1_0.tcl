...
proc update_PARAM_VALUE.RAM_ADDR_LOCAL { PARAM_VALUE.RAM_ADDR_LOCAL } {
	# Procedure called to update RAM_ADDR_LOCAL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RAM_ADDR_LOCAL { PARAM_VALUE.RAM_ADDR_LOCAL } {
	# Procedure called to validate RAM_ADDR_LOCAL
	return true
}
...
proc update_MODELPARAM_VALUE.RAM_ADDR_LOCAL { MODELPARAM_VALUE.RAM_ADDR_LOCAL PARAM_VALUE.RAM_ADDR_LOCAL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RAM_ADDR_LOCAL}] ${MODELPARAM_VALUE.RAM_ADDR_LOCAL}
}
