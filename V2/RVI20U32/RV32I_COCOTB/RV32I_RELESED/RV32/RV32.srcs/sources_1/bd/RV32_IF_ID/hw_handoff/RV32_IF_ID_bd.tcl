...
################################################################
# This is a generated script based on design: RV32_IF_ID
#
...
# source RV32_IF_ID_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# if_id_reg, pc_to_imem_addr, pc_unit, rom_memory, sim_constant
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports clk] [get_bd_pins if_id_reg_0/clk] [get_bd_pins pc_unit_0/clk] [get_bd_pins rom_memory_0/clk]
  ...
  connect_bd_net -net if_id_reg_0_id_instr [get_bd_ports id_instr_debug] [get_bd_pins if_id_reg_0/id_instr]
  connect_bd_net -net if_id_reg_0_id_pc [get_bd_ports id_pc_debug] [get_bd_pins if_id_reg_0/id_pc]
  connect_bd_net -net if_id_reg_0_id_pc_plus4 [get_bd_ports id_pc_plus4_debug] [get_bd_pins if_id_reg_0/id_pc_plus4]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins if_id_reg_0/rst] [get_bd_pins pc_unit_0/rst]
