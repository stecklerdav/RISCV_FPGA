...
HD_PWD='/media/steckler/xilinx_linux/RISCV_ZYNQ/V2/RVI20U32/RV32I_COCOTB/OLD/RV32I_RELESED/RV32/RV32.runs/RV32_IF_ID_rom_memory_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32_IF_ID_rom_memory_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32_IF_ID_rom_memory_0_0.tcl
