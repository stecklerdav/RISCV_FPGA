...
proc create_hier_cell_Core_RV32I { parentCell nameHier } {
  ...
  connect_bd_net -net RV32I_IF_pc [get_bd_pins pc] [get_bd_pins RV32I_IF/pc]
...
proc create_root_design { parentCell } {
  ...
  set pc [ create_bd_port -dir O -from 31 -to 0 pc ]
  ...
  connect_bd_net -net Core_RV32I_pc [get_bd_ports pc] [get_bd_pins Core_RV32I/pc]
  ...
  connect_bd_net -net uart_tx_0_ready [get_bd_ports ready] [get_bd_pins MMIO/uart_ready] [get_bd_pins xlconstant_3/dout]
