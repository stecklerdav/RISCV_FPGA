...
module RISCV_COCOTB(clk, dmem_addr, dmem_be, dmem_valid, dmem_wdata, 
  ...
  id_pc_out, id_valid_out, mem_req_ready, mem_rsp_valid, mem_store_data, 
  ...
  ready_3, regfile_we, rst, timer_ready, tx, wb_rd, wb_rd_we, wb_valid)
/* synthesis syn_black_box black_box_pad_pin="clk,dmem_addr[31:0],dmem_be[3:0],dmem_valid,dmem_wdata[31:0],dmem_we,ex_rs2[4:0],ex_store_data[31:0],forward_store[1:0],gpio_dir_0[7:0],gpio_in[7:0],gpio_out[7:0],id_instr_out[31:0],id_pc_out[31:0],id_valid_out,mem_req_ready,mem_rsp_valid,mem_store_data[31:0],pc_debug_last_predict_0[31:0],pc_debug_last_priv_redirect_0[31:0],pc_debug_last_redirect_0[31:0],pc_debug_predict_pulse_0,pc_debug_priv_redirect_pulse_0,pc_debug_redirect_pulse_0,priv_redirect_target_0[31:0],priv_redirect_valid_0,rd_wdata[31:0],rdata[31:0],ready,ready_1,ready_2,ready_3,regfile_we,rst,timer_ready,tx,wb_rd[4:0],wb_rd_we,wb_valid" */;
  input clk;
