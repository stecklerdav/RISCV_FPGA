...
namespace eval ::optrace {
  variable script "/media/steckler/xilinx_linux/RISCV_ZYNQ/V2/RVI20U32/RV32I_COCOTB/RISCV_ZYNQ_ON_TEST/RISCV.runs/synth_1/RISCV_COCOTB_wrapper.tcl"
...
read_verilog -library xil_defaultlib /media/steckler/xilinx_linux/RISCV_ZYNQ/V2/RVI20U32/RV32I_COCOTB/RISCV_ZYNQ_ON_TEST/RISCV.srcs/sources_1/imports/hdl/RISCV_COCOTB_wrapper.v
...
set_property used_in_implementation false [get_files /media/steckler/xilinx_linux/RISCV_ZYNQ/V2/RVI20U32/RV32I_COCOTB/RISCV_ZYNQ_ON_TEST/RISCV.srcs/constrs_1/new/src.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top RISCV_COCOTB_wrapper -part xczu5ev-sfvc784-2-i
...
write_checkpoint -force -noxdef RISCV_COCOTB_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file RISCV_COCOTB_wrapper_utilization_synth.rpt -pb RISCV_COCOTB_wrapper_utilization_synth.pb"
