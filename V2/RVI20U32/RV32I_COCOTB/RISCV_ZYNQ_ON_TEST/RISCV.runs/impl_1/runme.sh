...
HD_PWD='/media/steckler/xilinx_linux/RISCV_ZYNQ/V2/RVI20U32/RV32I_COCOTB/RISCV_ZYNQ_ON_TEST/RISCV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_COCOTB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_COCOTB_wrapper.tcl -notrace
