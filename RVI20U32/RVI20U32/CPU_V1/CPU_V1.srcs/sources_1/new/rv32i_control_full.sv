...
`include "rv32i_control_types.sv"
...
module rv32i_control_full (
    ...
    input  logic [2:0] fmt,      // optional, currently unused
    input  logic       bit30,    // instr[30]
    ...
    localparam logic [1:0] WB_RSV = 2'd3;
    ...
    always_comb begin
        ...
        ctrl_r.opA_sel      = A_RS1;
        ctrl_r.opB_sel      = B_RS2;
        ctrl_r.imm_sel      = IMM_I;

        ctrl_r.mem_re       = 1'b0;
        ctrl_r.mem_we       = 1'b0;
        ctrl_r.lsu_size     = SZ_W;
        ctrl_r.lsu_unsigned = 1'b0;

        ctrl_r.branch_en    = 1'b0;
        ctrl_r.branch_f3    = funct3;
        ctrl_r.jal          = 1'b0;
        ctrl_r.jalr         = 1'b0;
        ...
        unique case (opcode)
            ...
            7'b0000011: begin
                ...
                unique case (funct3)
                    3'b000: begin ctrl_r.lsu_size = SZ_B; ctrl_r.lsu_unsigned = 1'b0; end
                    3'b001: begin ctrl_r.lsu_size = SZ_H; ctrl_r.lsu_unsigned = 1'b0; end
                    3'b010: begin ctrl_r.lsu_size = SZ_W; ctrl_r.lsu_unsigned = 1'b0; end
                    3'b100: begin ctrl_r.lsu_size = SZ_B; ctrl_r.lsu_unsigned = 1'b1; end
                    3'b101: begin ctrl_r.lsu_size = SZ_H; ctrl_r.lsu_unsigned = 1'b1; end
                    default: begin ctrl_r.lsu_size = SZ_W; ctrl_r.lsu_unsigned = 1'b0; end
                endcase
            end
            ...
            7'b0100011: begin
                ...
                unique case (funct3)
                    3'b000: ctrl_r.lsu_size = SZ_B;
                    3'b001: ctrl_r.lsu_size = SZ_H;
                    3'b010: ctrl_r.lsu_size = SZ_W;
                    default: ctrl_r.lsu_size = SZ_W;
                endcase
            end
