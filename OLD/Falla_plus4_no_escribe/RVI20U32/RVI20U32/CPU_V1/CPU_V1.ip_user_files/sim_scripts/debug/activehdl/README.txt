...
#
# Generated by export_simulation on Sun Apr 19 22:31:22 WEST 2026
#
################################################################################
...
'-reset_run' switch to the './debug.sh' script.
...
./debug.sh -noclean_files

For more information on the script, please type './debug.sh -help'.
