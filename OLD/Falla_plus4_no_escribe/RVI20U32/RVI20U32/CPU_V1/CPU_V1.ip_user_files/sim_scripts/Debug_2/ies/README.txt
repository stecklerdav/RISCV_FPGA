...
#
# Generated by export_simulation on Sun Apr 19 22:47:22 WEST 2026
#
################################################################################
...
'-reset_run' switch to the './Debug_2.sh' script.

./Debug_2.sh -reset_run
...
./Debug_2.sh -noclean_files

For more information on the script, please type './Debug_2.sh -help'.
