...
//Date        : Sun Apr 19 22:47:21 2026
//Host        : steckler-Default-string running 64-bit Ubuntu 18.04.6 LTS
//Command     : generate_target Debug_2.bd
//Design      : Debug_2
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Debug_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Debug_2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=38,numReposBlks=32,numNonXlnxBlks=0,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=21,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "Debug_2.hwdef" *) 
module Debug_2
   ();

  wire [1:0]Net3;
  wire [3:0]RV32I_ID_ex_alu_op1;
  wire RV32I_ID_ex_branch_en1;
  wire [2:0]RV32I_ID_ex_branch_funct4;
  wire [31:0]RV32I_ID_ex_imm1;
  wire [31:0]RV32I_ID_ex_imm_u1;
  wire RV32I_ID_ex_jal1;
  wire RV32I_ID_ex_jalr1;
  wire RV32I_ID_ex_mem_re1;
  wire [1:0]RV32I_ID_ex_mem_size1;
  wire RV32I_ID_ex_mem_unsigned1;
  wire RV32I_ID_ex_mem_we1;
  wire [1:0]RV32I_ID_ex_op_a_sel2;
  wire [31:0]RV32I_ID_ex_pc1;
  wire [31:0]RV32I_ID_ex_pc_plus5;
  wire [4:0]RV32I_ID_ex_rd1;
  wire RV32I_ID_ex_rd_we1;
  wire [31:0]RV32I_ID_ex_rs1_data1;
  wire [31:0]RV32I_ID_ex_rs2_data1;
  wire [4:0]RV32I_ID_ex_rs3;
  wire [4:0]RV32I_ID_ex_rs4;
  wire RV32I_ID_ex_valid1;
  wire [1:0]RV32I_ID_ex_wb_sel1;
  wire [31:0]RV32I_IF_pc_id_out;
  wire [31:0]RV32I_IF_pc_plus4_id_out;
  wire [31:0]RV32I_MEM_wb_alu_result1;
  wire [31:0]RV32I_MEM_wb_data1;
  wire [31:0]RV32I_MEM_wb_imm_u1;
  wire [31:0]RV32I_MEM_wb_pc_plus5;
  wire [4:0]RV32I_MEM_wb_rd1;
  wire RV32I_MEM_wb_rd_we1;
  wire [1:0]RV32I_MEM_wb_sel1;
  wire RV32I_MEM_wb_valid1;
  wire [0:0]RV32I_RESET_Res;
  wire [31:0]RV32I_WB_rd_wdata1;
  wire id_valid_1;
  wire [31:0]instr_1;
  wire [31:0]mem_alu_result_2;
  wire [31:0]mem_imm_u_2;
  wire mem_mem_re_2;
  wire [1:0]mem_mem_size_2;
  wire mem_mem_unsigned_2;
  wire mem_mem_we_2;
  wire [31:0]mem_pc_plus4_2;
  wire [4:0]mem_rd_2;
  wire mem_rd_we_2;
  wire [31:0]mem_store_data_2;
  wire mem_valid_2;
  wire [1:0]mem_wb_sel_2;
  ...
  RV32I_EX_imp_1NLDE4Q RV32I_EX
       (.alu_op(RV32I_ID_ex_alu_op1),
        .base_data(RV32I_ID_ex_rs1_data1),
        .clk(zynq_ultra_ps_e_1_pl_clk0),
        .ex_branch_en(RV32I_ID_ex_branch_en1),
        .ex_branch_funct3(RV32I_ID_ex_branch_funct4),
        .ex_flush_req(rv32i_branch_unit_wr_0_ex_flush_req),
        .ex_imm_u(RV32I_ID_ex_imm_u1),
        .ex_jal(RV32I_ID_ex_jal1),
        .ex_jalr(RV32I_ID_ex_jalr1),
        .ex_mem_re(RV32I_ID_ex_mem_re1),
        .ex_mem_size(RV32I_ID_ex_mem_size1),
        .ex_mem_unsigned(RV32I_ID_ex_mem_unsigned1),
        .ex_mem_we(RV32I_ID_ex_mem_we1),
        .ex_pc(RV32I_ID_ex_pc1),
        .ex_pc_plus4(RV32I_ID_ex_pc_plus5),
        .ex_rd(RV32I_ID_ex_rd1),
        .ex_rd_we(RV32I_ID_ex_rd_we1),
        .ex_rs1(RV32I_ID_ex_rs3),
        .ex_rs2(RV32I_ID_ex_rs4),
        .ex_store_data(RV32I_ID_ex_rs2_data1),
        .ex_valid(RV32I_ID_ex_valid1),
        .ex_wb_sel(RV32I_ID_ex_wb_sel1),
        .imm(RV32I_ID_ex_imm1),
        .mem_alu_result(mem_alu_result_2),
        .mem_imm_u(mem_imm_u_2),
        .mem_mem_re(mem_mem_re_2),
        .mem_mem_size(mem_mem_size_2),
        .mem_mem_unsigned(mem_mem_unsigned_2),
        .mem_mem_we(mem_mem_we_2),
        .mem_pc_plus4(mem_pc_plus4_2),
        .mem_rd(mem_rd_2),
        .mem_rd_we(mem_rd_we_2),
        .mem_store_data(mem_store_data_2),
        .mem_valid(mem_valid_2),
        .mem_wb_data(RV32I_WB_rd_wdata1),
        .mem_wb_sel(mem_wb_sel_2),
        .op_a_sel(RV32I_ID_ex_op_a_sel2),
        .op_b_sel(Net3),
        .pc_redirect_target(rv32i_branch_unit_wr_0_pc_redirect_target),
        .pc_redirect_valid(rv32i_branch_unit_wr_0_pc_redirect_valid),
        .rst(RV32I_RESET_Res),
        .wb_rd(RV32I_MEM_wb_rd1),
        .wb_rd_we(RV32I_MEM_wb_rd_we1));
  RV32I_ID_imp_7QQ18A RV32I_ID
       (.bubble(rv32i_branch_unit_wr_0_ex_flush_req),
        .clk(zynq_ultra_ps_e_1_pl_clk0),
        .ex_alu_op(RV32I_ID_ex_alu_op1),
        .ex_branch_en(RV32I_ID_ex_branch_en1),
        .ex_branch_funct3(RV32I_ID_ex_branch_funct4),
        .ex_imm(RV32I_ID_ex_imm1),
        .ex_imm_u(RV32I_ID_ex_imm_u1),
        .ex_jal(RV32I_ID_ex_jal1),
        .ex_jalr(RV32I_ID_ex_jalr1),
        .ex_mem_re(RV32I_ID_ex_mem_re1),
        ...
        .ex_mem_unsigned(RV32I_ID_ex_mem_unsigned1),
        .ex_mem_we(RV32I_ID_ex_mem_we1),
        .ex_op_a_sel1(RV32I_ID_ex_op_a_sel2),
        .ex_op_b_sel(Net3),
        .ex_pc(RV32I_ID_ex_pc1),
        .ex_pc_plus4(RV32I_ID_ex_pc_plus5),
        .ex_rd(RV32I_ID_ex_rd1),
        .ex_rd_we(RV32I_ID_ex_rd_we1),
        .ex_rs1(RV32I_ID_ex_rs3),
        .ex_rs1_data(RV32I_ID_ex_rs1_data1),
        .ex_rs2(RV32I_ID_ex_rs4),
        .ex_rs2_data(RV32I_ID_ex_rs2_data1),
        .ex_valid(RV32I_ID_ex_valid1),
        .ex_wb_sel(RV32I_ID_ex_wb_sel1),
        ...
        .id_valid(id_valid_1),
        .instr(instr_1),
        .rd_addr(RV32I_MEM_wb_rd1),
        .rd_wdata(RV32I_WB_rd_wdata1),
        .rd_we(util_vector_logic_2_Res1),
        .rst(RV32I_RESET_Res));
  RV32I_IF_imp_OWKUYV RV32I_IF
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
  ...
  RV32I_MEM_imp_15RZZ0N RV32I_MEM
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
        .flush(1'b0),
        .mem_alu_result(mem_alu_result_2),
        .mem_imm_u(mem_imm_u_2),
        ...
        .mem_wb_sel(mem_wb_sel_2),
        .rst(RV32I_RESET_Res),
        .wb_alu_result(RV32I_MEM_wb_alu_result1),
        .wb_data(RV32I_MEM_wb_data1),
        .wb_imm_u(RV32I_MEM_wb_imm_u1),
        .wb_pc_plus4(RV32I_MEM_wb_pc_plus5),
        .wb_rd(RV32I_MEM_wb_rd1),
        .wb_rd_we(RV32I_MEM_wb_rd_we1),
        .wb_sel(RV32I_MEM_wb_sel1),
        .wb_valid(RV32I_MEM_wb_valid1));
  RV32I_RESET_imp_DNP4US RV32I_RESET
       (.Op2(vio_0_probe_out0),
        .Res(RV32I_RESET_Res),
        .clk(zynq_ultra_ps_e_1_pl_clk0),
        .ext_reset_in(zynq_ultra_ps_e_1_pl_resetn0));
  RV32I_WB_imp_1FHBV1A RV32I_WB
       (.alu_y(RV32I_MEM_wb_alu_result1),
        .imm_u(RV32I_MEM_wb_imm_u1),
        .load_data(RV32I_MEM_wb_data1),
        .pc_plus4(RV32I_MEM_wb_pc_plus5),
        .rd_wdata(RV32I_WB_rd_wdata1),
        .wb_sel(RV32I_MEM_wb_sel1));
  Debug_2_util_vector_logic_2_0 util_vector_logic_2
       (.Op1(RV32I_MEM_wb_rd_we1),
        .Op2(RV32I_MEM_wb_valid1),
        .Res(util_vector_logic_2_Res1));
  Debug_2_vio_0_1 vio_0
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
        .probe_out0(vio_0_probe_out0));
  Debug_2_zynq_ultra_ps_e_1_1 zynq_ultra_ps_e_1
...
module RV32I_EX_imp_1NLDE4Q
  ...
  Debug_2_rv32i_branch_unit_wr_0_0 rv32i_branch_unit_wr_0
       (.ex_branch_en(RV32I_ID_ex_branch_en),
        ...
        .pc_redirect_target(rv32i_branch_unit_wr_0_pc_redirect_target),
        .pc_redirect_valid(rv32i_branch_unit_wr_0_pc_redirect_valid));
  Debug_2_rv32i_ex_mem_reg_wra_0_0 rv32i_ex_mem_reg_wra_0
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
...
module RV32I_ID_imp_7QQ18A
  ...
  assign zynq_ultra_ps_e_1_pl_clk0 = clk;
  Debug_2_rv32i_control_full_w_0_0 rv32i_control_full_w_0
  ...
  Debug_2_rv32i_decoder_wrapper_0_0 rv32i_decoder_wrapper_0
       (.bit30(rv32i_decoder_wrapper_0_bit30),
        .fmt(rv32i_decoder_wrapper_0_fmt),
        .funct3(rv32i_decoder_wrapper_0_funct3),
        .funct7(rv32i_decoder_wrapper_0_funct7),
  ...
  Debug_2_rv32i_id_ex_reg_wrap_0_0 rv32i_id_ex_reg_wrap_0
       (.bubble(bubble_1),
        .clk(zynq_ultra_ps_e_1_pl_clk0),
        ...
        .rst(RV32I_RESET_Res),
        .stall(1'b0));
  Debug_2_rv32i_imm_mux_wrapper_0_0 rv32i_imm_mux_wrapper_0
       (.imm_b(rv32i_decoder_wrapper_0_imm_b),
        .imm_i(rv32i_decoder_wrapper_0_imm_i),
        .imm_j(rv32i_decoder_wrapper_0_imm_j),
        ...
        .imm_sel(rv32i_control_full_w_0_imm_sel),
        .imm_u(rv32i_decoder_wrapper_0_imm_u));
  Debug_2_rv32i_regfile_wrapper_0_0 rv32i_regfile_wrapper_0
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
        .rd_addr(rd_addr_1),
        .rd_wdata(rd_wdata_1),
        .rd_we(rd_we_1),
...
module RV32I_IF_imp_OWKUYV
  ...
  assign zynq_ultra_ps_e_1_pl_clk0 = clk;
  Debug_2_blk_mem_gen_0_1 blk_mem_gen_0
       (.addra(pc_to_rom_addr_wrapp_0_a),
        .clka(zynq_ultra_ps_e_1_pl_clk0),
        .douta(blk_mem_gen_0_douta),
        .ena(xlconstant_1_dout));
  Debug_2_pc_to_rom_addr_wrapp_0_1 pc_to_rom_addr_wrapp_0
       (.a(pc_to_rom_addr_wrapp_0_a),
        .pc(pc_unit_wrapper_0_pc));
  Debug_2_pc_unit_wrapper_0_1 pc_unit_wrapper_0
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
        .pc(pc_unit_wrapper_0_pc),
        ...
        .rst(RV32I_RESET_Res));
  Debug_2_rv32i_if_id_reg_wrap_0_1 rv32i_if_id_reg_wrap_0
       (.clk(zynq_ultra_ps_e_1_pl_clk0),
        .flush(flush_1),
        .hold(1'b0),
  ...
  Debug_2_xlconstant_1_1 xlconstant_1
       (.dout(xlconstant_1_dout));
endmodule

module RV32I_MEM_imp_15RZZ0N
   (clk,
    flush,
    mem_alu_result,
    mem_imm_u,
  ...
  Debug_2_rv32i_load_extender_0_0 rv32i_load_extender_0
  ...
  Debug_2_rv32i_mem_stage_wrap_0_0 rv32i_mem_stage_wrap_0
       (.clk(Net2),
  ...
  Debug_2_rv32i_mem_wb_reg_wra_0_0 rv32i_mem_wb_reg_wra_0
       (.clk(Net2),
  ...
  Debug_2_rv32i_ram_datav_wrap_0_0 rv32i_ram_datav_wrap_0
  ...
  Debug_2_xlconstant_1_2 xlconstant_1
       (.dout(xlconstant_1_dout));
  Debug_2_xlslice_0_0 xlslice_0
       (.Din(rv32i_mem_stage_wrap_0_dmem_addr),
        .Dout(xlslice_0_Dout));
endmodule

module RV32I_RESET_imp_DNP4US
   (Op2,
    Res,
    clk,
    ext_reset_in);
  ...
  Debug_2_proc_sys_reset_0_1 proc_sys_reset_0
       (.aux_reset_in(1'b1),
  ...
  Debug_2_util_vector_logic_0_1 util_vector_logic_0
       (.Op1(proc_sys_reset_0_peripheral_reset),
        .Op2(Op2_1),
        .Res(util_vector_logic_0_Res));
  Debug_2_xlconstant_0_1 xlconstant_0
       (.dout(xlconstant_0_dout));
endmodule

module RV32I_WB_imp_1FHBV1A
   (alu_y,
    imm_u,
    load_data,
    pc_plus4,
  ...
  Debug_2_rv32i_wb_mux_wrapper_0_0 rv32i_wb_mux_wrapper_0
       (.alu_y(alu_y_1),
        .imm_u(imm_u_1),
