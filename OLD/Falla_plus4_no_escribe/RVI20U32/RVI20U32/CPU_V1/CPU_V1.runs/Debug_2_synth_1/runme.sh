...
HD_PWD='/media/steckler/xilinx_linux/RISCV_ZYNQ/Con_problema_plus4_no_escribe/RVI20U32/RVI20U32/CPU_V1/CPU_V1.runs/Debug_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Debug_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Debug_2.tcl
